    ...
    render : function () {
      ...
      return(
        React.createElement("div", {className: "container"}, 
          ...
          React.createElement(SearchForm, {update: this.addTemData, changeState: this.changeState}), 
          React.createElement("h2", null, resultTitle), 
          React.createElement("div", {className: "container"}, 
            React.createElement(Results, {memory: data, setter: this.setId})
          ), 
          React.createElement("div", {id: "moviedetails", className: "modal fade", role: "dialog"}, 
              ...
              React.createElement("div", {className: "modal-body"}, 
                  React.createElement("div", {className: "row"}, 
                    React.createElement("div", {className: "col-sm-4"}, 
                      React.createElement("img", {src: this.state.tmpmovie.Poster, className: "img-thumbnail"})
                    ), 
                    React.createElement("div", {className: "col-sm-8"}, 
                    React.createElement("h3", null, "Movie Name :", this.state.tmpmovie.Title), 
                    React.createElement("h4", null, "Year :", this.state.tmpmovie.Year), 
                    ...
                    React.createElement("p", null, 
                    React.createElement("span", {className: "glyphicon glyphicon-calendar"}), " ", this.state.tmpmovie.Released, 
                    React.createElement("strong", null, "| Awards :"), 
                     this.state.tmpmovie.Awards
                    ), 
                    React.createElement("h4", null, 
                    React.createElement("strong", null, "Rating :"), 
                    React.createElement(ReviewStars, {rating: this.state.tmpmovie.imdbRating, rate: this.changeRating})
                    ), 

                    React.createElement("br", null), 
                    React.createElement("p", null, 
                      React.createElement("button", {type: "button", className: "btn btn-primary", "data-dismiss": "modal", onClick: btnType}, React.createElement("span", {className: "glyphicon glyphicon-save"}), " ", React.createElement("span", null, btnText)), 
                      React.createElement("button", {type: "button", className: "btn btn-warning", "data-dismiss": "modal", onClick: this.updateRating, style: {"display":btnDisble,"marginLeft":"20px"}}, React.createElement("span", {className: "glyphicon glyphicon-thumbs-up"}), " ", React.createElement("span", null, "Save Changes"))
                    )
                    )
                  )
              ), 
              React.createElement("div", {className: "modal-footer"}, 
                React.createElement("button", {type: "button", className: "btn btn-success", "data-dismiss": "modal"}, "Close")
              )
              )
            )
          )
...
},{"./Navbar":202,"./Results":203,"./ReviewStars":204,"./SearchForm":205,"react":199}],201:[function(require,module,exports){
var React = require('react');
var Navbar = require('./Navbar');
...
module.exports = Home;
},{"./Navbar":202,"react":199}],202:[function(require,module,exports){
var React = require('react');
...
var Navbar = React.createClass({displayName: "Navbar",
    ...
    React.createElement("div", {className: "container-fluid"}, 
      ...
      React.createElement("ul", {className: "nav navbar-nav"}, 
        React.createElement("li", {className: "active"}, React.createElement("a", {href: "#"}, React.createElement(Link, {to: "/home"}, "Home "))), 
        React.createElement("li", null, React.createElement("a", {href: "#"}, React.createElement(Link, {to: "/movies"}, "Movies ")))
      )
    )
  )
        )
...
var Results = React.createClass({displayName: "Results",
  moviedetails : function(movie,ref) {
      return(
        React.createElement("div", {className: "row panel panel-default", key: movie.imdbID, style: {marginTop:"20px"}}, 
          React.createElement("div", {className: "col-sm-2"}, 
            React.createElement("img", {src: movie.Poster, className: "img-thumbnail"})
          ), 
          React.createElement("div", {className: "col-sm-8"}, 
            React.createElement("h3", null, "Movie Name :", movie.Title), 
            React.createElement("h3", null, "Year :", movie.Year)

          ), 
          React.createElement("div", {className: "col-sm-2"}, 
            React.createElement("button", {type: "button", className: "btn btn-warning btn-block", style: {marginTop:"100px"}, 
...
var React = require('react');
var ReviewStars = React.createClass({displayName: "ReviewStars",
  render(){
    ...
    for(var i=1;i<=10;i++){
      let z = i;
      if(i<=rating){
        stars.push(React.createElement("span", {className: "glyphicon glyphicon-star", key: i, onClick: (event) => {this.props.rate(z)}, style: {"color" : "green"}}));
      }
      else{
        stars.push(React.createElement("span", {className: "glyphicon glyphicon-star-empty", key: i, onClick: (event) => {this.props.rate(z)}}));
      }
    }
  ...
  render:function() {
    return(
      React.createElement("div", null, 
        React.createElement("form", {className: "form-inline", role: "form", onSubmit: this.submitHandler}, 
          React.createElement("div", {className: "form-group"}, 
            React.createElement("label", null, "Enter Movie:"), 
            React.createElement("input", {type: "text", className: "form-control", id: "title", placeholder: "Title", 
            value: this.state.title, onChange: this.handleTitleChange})
          ), 
          React.createElement("button", {type: "submit", className: "btn btn-info submit-btn", "data-toggle": "modal", "data-target": "#myModal"}, "Search"), 
          React.createElement("button", {type: "reset", className: "btn btn-danger", onClick: this.handleReset}, "Reset")
        )
      )
      )
    }
...
},{"./components/Content":200,"./routes.js":209,"react":199,"react-dom":10,"react-router":35}],207:[function(require,module,exports){
var React = require('react');
var Router = require('react-router');
...
},{"react":199,"react-router":35}],208:[function(require,module,exports){
var React = require('react');
...
},{"./../components/Navbar":202,"react":199}],209:[function(require,module,exports){
var React = require('react');
var Router = require('react-router');
...
module.exports = (
  ...
  React.createElement(Route, {handler: Master}, 
      React.createElement(DefaultRoute, {handler: Index, name: "HomePage"}
      ), 
      React.createElement(Route, {path: "/home", handler: Home}), 
      React.createElement(Route, {path: "/movies", handler: Content})
  )

  )
);
},{"./components/Content":200,"./components/Home":201,"./pages/":208,"./pages/Master/Master":207,"react":199,"react-router":35}]},{},[206]);
